...
```{r MyPermTest pvalue, echo=FALSE}
...
```{r rejtable, echo=FALSE, warning=FALSE}
set.seed(SEED)
rbind(
  `r=0.2` = CorTestRep(n = 100, size = 10, r = 0.2, alpha = 0.05),
  `r=0.8` = CorTestRep(n = 100, size = 10, r = 0.8, alpha = 0.05)) %>% 
...
```{r ref.label=c("stack data", "Mylm", "lm", "Mylm coef"), echo=TRUE, eval=FALSE}
```
